...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-2 group">
      {/* Tooltip banner */}
      {tooltipOpen && (
        <div className="relative bg-white text-navy border border-navy/10 shadow-xl rounded-xl p-3 pr-8 max-w-[260px] text-xs leading-relaxed animate-fade-in">
          <button
            onClick={(e) => {
              e.stopPropagation();
          ...
          <p className="text-navy/70">
            Need help with <strong>sizing</strong>, <strong>custom prints</strong>, or <strong>bulk orders</strong>?
          </p>
        </div>
      )}
